...
class PVT_V2_B0(PyramidVisionTransformer, Backbone):
    def __init__(self, cfg, input_shape):
        ...
        self._out_feature_channels = dict(
            (k, n) for k, n in zip(cfg.MODEL.BACKBONE.FEATURE_KEYS, cfg.MODEL.BACKBONE.NUM_FEATURES)
        )
...
@BACKBONE_REGISTRY.register()
class PVT_V2_B1(PyramidVisionTransformer, Backbone):
    def __init__(self, cfg, input_shape):
        super().__init__(
...
@BACKBONE_REGISTRY.register()
class PVT_V2_B2(PyramidVisionTransformer, Backbone):
    def __init__(self, cfg, input_shape):
        super().__init__(
            patch_size=4, embed_dims=[64, 128, 320, 512], num_heads=[1, 2, 5, 8], mlp_ratios=[8, 8, 4, 4],
...
@BACKBONE_REGISTRY.register()
class PVT_V2_B3(PyramidVisionTransformer, Backbone):
    def __init__(self, cfg, input_shape):
        super().__init__(
            patch_size=4, embed_dims=[64, 128, 320, 512], num_heads=[1, 2, 5, 8], mlp_ratios=[8, 8, 4, 4],
...
@BACKBONE_REGISTRY.register()
class PVT_V2_B4(PyramidVisionTransformer, Backbone):
    def __init__(self, cfg, input_shape):
        super().__init__(
            patch_size=4, embed_dims=[64, 128, 320, 512], num_heads=[1, 2, 5, 8], mlp_ratios=[8, 8, 4, 4],
